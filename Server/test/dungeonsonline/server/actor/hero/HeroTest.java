...
public class HeroTest {
    ...
    public void testTakeHealingSuccess() {
        ...
        Assert.assertEquals("takeHealing should increase hero's health correctly",
    ...
    public void testTakeManaSuccess() {
        ...
        Assert.assertEquals("takeMana should increase hero's mana correctly",
    ...
    public void testEquipWithSameOrLowerLevelWeaponThanHeroLevelWhenHeroHasNoWeaponEquipped() {
        ...
        Assert.assertEquals("equip must equip weapon which level is lower or equal to hero's level " +
    ...
    public void testEquipWithSameOrLowerLevelWeaponThanHeroLevelWhenHeroHasWeaponWithHigherDamageEquipped() {
        ...
        Assert.assertEquals("equip must not equip weapon which level is lower or equal to hero's level " +
    ...
    public void testLearnWithSameOrLowerLevelSpellThanHeroLevelWhenHeroHasNoSpellEquipped() {
        ...
        Assert.assertEquals("learn must learn spell which level is lower or equal to hero's level " +
    ...
    public void testLearnWithSameOrLowerLevelSpellThanHeroLevelWhenHeroHasSpellWithHigherDamageLearnt() {
        ...
        Assert.assertEquals("learn must not learn spell which level is lower or equal to hero's level " +
