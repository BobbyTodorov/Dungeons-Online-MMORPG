...
public class Hero extends BaseActor implements IHero {
    ...
    private static final int HERO_STARTING_HEALTH = 100;
    private static final int HERO_STARTING_MANA = 100;
    private static final int HERO_STARTING_ATTACK = 50;
    private static final int HERO_STARTING_DEFENSE = 50;
    ...
    public static Stats startingHeroStats() {
        return new Stats(
            HERO_STARTING_HEALTH,
            HERO_STARTING_MANA,
            HERO_STARTING_ATTACK,
            HERO_STARTING_DEFENSE
        );
    }
